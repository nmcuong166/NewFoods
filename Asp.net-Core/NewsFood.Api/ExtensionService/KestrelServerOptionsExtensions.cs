...
namespace NewsFood.Api.ExtensionService
{
                    ...
                    options.ListenAnyIP(port,
                         listenOptions =>
                         {
                             if (config.Scheme == "https")
                             {
                                 ...
                                 listenOptions.UseHttps(certificate, optionSecurity =>
                                 {
                                     optionSecurity.SslProtocols = System.Security.Authentication.SslProtocols.Tls12;
                                 });
                             }
                         });
                }
